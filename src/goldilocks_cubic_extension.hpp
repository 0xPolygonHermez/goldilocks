...
public:
    ...
    static void copy_pack( uint64_t nrowsPack, Goldilocks::Element *dst, const Goldilocks::Element *src);
    static void load_pack( uint64_t nrowsPack, Goldilocks::Element *dst, uint64_t stride_c, const Goldilocks::Element *src, uint64_t stride_a);
    static void store_pack( uint64_t nrowsPack, Goldilocks::Element *dst, uint64_t stride_c, const Goldilocks::Element *src, uint64_t stride_a);
