...
TEST(GOLDILOCKS_TEST, add_avx)
{
    ...
    ASSERT_EQ(Goldilocks::toU64(p_1 + p_1), Goldilocks::toU64(c[0]));
    ASSERT_EQ(Goldilocks::toU64(a1 + a2), Goldilocks::toU64(c[1]));
    ASSERT_EQ(Goldilocks::toU64(inE1 + inE2), Goldilocks::toU64(c[2]));
    ASSERT_EQ(Goldilocks::toU64(max + max), Goldilocks::toU64(c[3]));
    ...
    ASSERT_EQ(Goldilocks::toU64(p_1 + p_1 + inE3), Goldilocks::toU64(b[0]));
    ASSERT_EQ(Goldilocks::toU64(c[1] + c[1]), Goldilocks::toU64(b[1]));
    ASSERT_EQ(Goldilocks::toU64(inE1 + inE2 + inE4), Goldilocks::toU64(b[2]));
    ASSERT_EQ(Goldilocks::toU64(max + max + max), Goldilocks::toU64(b[3]));
}
